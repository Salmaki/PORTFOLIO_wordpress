...
class Cooking_Master_Class_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function cooking_master_class_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cooking_master_class_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cooking_master_class_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cooking_master_class_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cooking_master_class_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cooking_master_class_load( $class ) {
