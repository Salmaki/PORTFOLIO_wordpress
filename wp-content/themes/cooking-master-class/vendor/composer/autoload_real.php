...
class Cooking_Master_Class_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function cooking_master_class_loadClassLoader($class)
    {
    ...
    public static function cooking_master_class_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
