...
if ( ! class_exists( 'Cooking_Master_Class_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Cooking_Master_Class_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Cooking_Master_Class_WPTT_WebFont_Loader( $url );
